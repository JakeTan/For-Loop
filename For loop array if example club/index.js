...
for (let i=0; i < nightClubRegister.length; i++) {
    ...
    if (nightClubRegister[i].age >= 21) {
        if (nightClubRegister[i].gender === 'male'){
            console.log('Hi Mr ' + nightClubRegister[i].lastname + ', welcome to enter the club')
        }
        if (nightClubRegister[i].geder === 'female'){
           console.log('Hi Mrs/Miss ' + nightClubRegister[i].lastname + ', welcome to enter the club')
        }
    }
